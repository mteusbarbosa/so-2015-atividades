...
:Nome: Mateus Barbosa Martins
:Matrícula: 20121144010753
:Data: 01/07/2015

cat
  Mostra o conteúdo de um ficheiro e é muito usado também para concatenar ficheiros, como por exemplo fazendo cat a.txt b.txt > c.txt” para juntar o ficheiro a.txt e b.txt num único de nome c.txt


cd
  Muda para uma pasta específica como também volta pra pasta inicial
  cd /var/www/...


cowsay
  Manda vacas pras inimigas pedindo nudes
  cowsay -f  formatodavaca "Escreva aq a mensagem" | write nomedealguem
...
echo
  ...
  $NAME = Mateus
  echo $NAME 
  Irá aparecer meu nome :#


env
  Exibe as variáveis de ambiente
  Variáveis que o sistema usa "qual usuário ta usando""local""PATH"
...
HISTTIMEFORMAT="%d/%m/%y
  Histórico que dia, mês, hora acessou a máquina
...
nome="fulano
  cria variável nome com valor fulano
  nome=mateus
  echo nome vai aparecer eu
...
vim
  abre um arquivo e modifica ele


wait
  Espera que um comando entre em execução para rodar outro comando


wall
 wall é p escrever uma mensagem a outros usuarios
  sudo wall message.txt
  vai mandar o conteudo de massage.txt a tds os usuarios
...
who
  mostra quem ta conectado


whoami
  mostra quem sou olar


write
 Manda algo pra alguem 
